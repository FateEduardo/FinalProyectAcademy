    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
			<div class="container-center ">
				<form class="well"  name="myForm" data-ng-submit="newItem()">
					<div class="container">
						<div class="form-group">
							<div class="col-sm-3">
								<input type="number" class="form-control input-group-lg reg_name"
									data-ng-value="count"data-ng-model="item.id"  name="id" readonly="readonly" >
							</div>
							<div class="col-sm-3">
						...
						<div class="col-sm-3">
								<input type="number" class="form-control input-group-lg"
									data-ng-value="item.price | number:2 "
						...
						<div class="form-group">
														<div class="col-sm-3">
								<select data-ng-model="item.active">
									<option value="true">Avalaible</option>
									<option value="false">Not Avalaible</option>
								</select>
							</div>	
										<div class="col-sm-3">
								<input type="text" class="form-control input-group-lg"
