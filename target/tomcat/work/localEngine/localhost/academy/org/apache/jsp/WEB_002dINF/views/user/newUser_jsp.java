...
public final class newUser_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"true\">S</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"false\">N</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<br/>\n");
      ...
      out.write("\t\t\t\t\t\t\t <button type=\"submit\" class=\"btn btn-info\" data-ng-click=\"submitted= true;\" >Submit</button>\n");
      out.write("\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\n");
